...
\cvtalk
    {\textbf{Upcoming}: UMTC-UMD Postdoc Seminar Program} % Seminar
    {UMD}
    {Understanding Contrastive Learning from Variational and Neural Network Optimization Perspectives} % talk subject
    {2024} % Date(s)
% \cvtalk
%     {\textbf{Upcoming}: (Poster) SIAM Conference on Mathematics of Data Science (MDS24)} % Seminar
%     {Atlanta Georgia}
%     {Geometry-preserving encoder and decoder on latent diffusion models} % talk subject
%     {2024} % Date(s)
\cvtalk
    {\textbf{Upcoming}: SIAM Conference on Mathematics of Data Science (MDS24)} % Seminar
    {Atlanta Georgia}
    { Understanding Contrastive Learning from Variational and Neural Network Optimization Perspectives} % talk subject
    {2024} % Date(s)
\cvtalk
