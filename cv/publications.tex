...
\vspace{0.5cm}
\begin{cvitems}
  \item \textbf{W. Lee}, L. Wang, W. Li \href{}{\textit{Generalized Deep JKO: an IMEX particle method for kinetic Fokker-Planck equations}}, \textbf{Ongoing}
  \medskip
  \item \textbf{W. Lee}, R. O'Neill, D. Zou, J. Calder, G. Lerman \href{}{\textit{Geometry-Preserving Encoder/Decoder\\ In Latent Generative Models}}, \textbf{Ongoing}
  \medskip
  \item J. Calder, \textbf{W. Lee} \href{}{\textit{Understanding Contrastive Learning through Variational Analysis and Neural Network Optimization Perspectives}}, \textbf{Ongoing}
    \medskip
  \item M. Jacobs, \textbf{W. Lee} \href{}{\textit{An efficient numerical scheme for tumor growth models}}, \textbf{Ongoing}
    \medskip
